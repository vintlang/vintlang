...
1. **Download the Binary:**
   ...
   ```bash
   curl -O -L https://github.com/ekilie/vint-lang/releases/download/latest/vintLang_linux_amd64.tar.gz
   ```
...
1. **Download the Binary:**
   ...
   ```bash
   curl -O -L https://github.com/ekilie/vint-lang/releases/download/latest/vintLang_mac_amd64.tar.gz
   ```
