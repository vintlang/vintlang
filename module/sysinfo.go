...
func getMemInfo(args []object.Object, defs map[string]object.Object) object.Object {
    if len(args) != 0 {
        return ErrorMessage(
            "sysinfo", "memInfo",
            "No arguments",
...
func getCPUInfo(args []object.Object, defs map[string]object.Object) object.Object {
    if len(args) != 0 {
        return ErrorMessage(
            "sysinfo", "cpuInfo",
            "No arguments",
...
func getDiskInfo(args []object.Object, defs map[string]object.Object) object.Object {
    if len(args) != 0 {
        return ErrorMessage(
            "sysinfo", "diskInfo",
            "No arguments",
...
func getNetInfo(args []object.Object, defs map[string]object.Object) object.Object {
    if len(args) != 0 {
        return ErrorMessage(
            "sysinfo", "netInfo",
            "No arguments",
    ...
    var networkInterfaces []object.Object
