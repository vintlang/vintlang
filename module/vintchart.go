...
// Create a bar chart
func barChart(args []object.VintObject, defs map[string]object.VintObject) object.VintObject {
	if len(args) != 3 {
...
// Create a pie chart
func pieChart(args []object.VintObject, defs map[string]object.VintObject) object.VintObject {
	if len(args) != 3 {
...
// Create a line graph
func lineGraph(args []object.VintObject, defs map[string]object.VintObject) object.VintObject {
	if len(args) != 3 {
...
func saveChartToFile(filename string, data []byte) object.VintObject {
...
func objectArrayToStringSlice(objects []object.VintObject) []string {
	result := []string{}
...
func objectArrayToFloatSlice(objects []object.VintObject) []float64 {
	result := []float64{}
	for _, obj := range objects {
