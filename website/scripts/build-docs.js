 ...
 * instead of reading the filesystem at runtime (which doesn't work on Vercel)
 */
...
async function generateDocsRegistry() {
  try {
    ...
    const jsonContent = `{
  "_warning": "⚠️  AUTO-GENERATED FILE - DO NOT EDIT MANUALLY",
...
${JSON.stringify(registry, null, 2).slice(1, -1).split('\n').slice(1).join('\n')}
}`;
    
    fs.writeFileSync(outputPath, jsonContent);

    // Generate TypeScript types
    const typesContent = `// ⚠️  AUTO-GENERATED FILE - DO NOT EDIT MANUALLY
...
module.exports = { generateDocsRegistry };
