...
func (b *Boolean) Method(method string, args []Object) Object {
	switch method {
	case "to_string":
...
func (b *Boolean) toString(args []Object) Object {
	if len(args) != 0 {
...
func (b *Boolean) toInt(args []Object) Object {
	if len(args) != 0 {
...
func (b *Boolean) negate(args []Object) Object {
	if len(args) != 0 {
...
func (b *Boolean) and(args []Object) Object {
	if len(args) != 1 {
...
func (b *Boolean) or(args []Object) Object {
	if len(args) != 1 {
...
func (b *Boolean) xor(args []Object) Object {
	if len(args) != 1 {
...
func (b *Boolean) implies(args []Object) Object {
	if len(args) != 1 {
...
func (b *Boolean) equivalent(args []Object) Object {
	if len(args) != 1 {
...
func (b *Boolean) nor(args []Object) Object {
	if len(args) != 1 {
...
func (b *Boolean) nand(args []Object) Object {
	if len(args) != 1 {
