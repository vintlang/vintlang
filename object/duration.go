...
func (d *Duration) Method(method string, args []Object, defs map[string]Object) Object {
	switch method {
	case "hours":
...
func (d *Duration) hours(args []Object, defs map[string]Object) Object {
	if len(defs) != 0 {
...
func (d *Duration) minutes(args []Object, defs map[string]Object) Object {
	if len(defs) != 0 {
...
func (d *Duration) seconds(args []Object, defs map[string]Object) Object {
	if len(defs) != 0 {
...
func (d *Duration) milliseconds(args []Object, defs map[string]Object) Object {
	if len(defs) != 0 {
...
func (d *Duration) nanoseconds(args []Object, defs map[string]Object) Object {
	if len(defs) != 0 {
...
func (d *Duration) string(args []Object, defs map[string]Object) Object {
	if len(defs) != 0 {
...
func (d *Duration) add(args []Object, defs map[string]Object) Object {
	if len(defs) != 0 {
...
func (d *Duration) subtract(args []Object, defs map[string]Object) Object {
	if len(defs) != 0 {
...
func (d *Duration) multiply(args []Object, defs map[string]Object) Object {
	if len(defs) != 0 {
...
func (d *Duration) divide(args []Object, defs map[string]Object) Object {
	if len(defs) != 0 {
