...
func (d *Dict) Method(method string, args []Object) Object {
	switch method {
	case "keys":
		return d.keys(args)
	case "values":
...
func (d *Dict) keys(args []Object) Object {
	if len(args) != 0 {
...
func (d *Dict) values(args []Object) Object {
	if len(args) != 0 {
...
func (d *Dict) size(args []Object) Object {
	if len(args) != 0 {
...
func (d *Dict) has(args []Object) Object {
	if len(args) != 1 {
...
func (d *Dict) get(args []Object) Object {
...
func (d *Dict) set(args []Object) Object {
	if len(args) != 2 {
...
func (d *Dict) remove(args []Object) Object {
	if len(args) != 1 {
...
func (d *Dict) clear(args []Object) Object {
	if len(args) != 0 {
...
func (d *Dict) merge(args []Object) Object {
	if len(args) != 1 {
...
func (d *Dict) copy(args []Object) Object {
	if len(args) != 0 {
